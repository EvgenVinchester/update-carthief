...
if enable_autoupdate then
  ...
  if updater_loaded then
    ...
    if autoupdate_loaded then
      Update.json_url = "https://raw.githubusercontent.com/EvgenVinchester/update-carthief/main/update.json" .. tostring(os.clock())
      Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
      Update.url = "https://github.com/EvgenVinchester/update-carthief"
    end
  end
end
